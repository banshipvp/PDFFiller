...
- Installer: `desktop-release/PDF Filler Setup 1.0.8.exe`
...
Install PDF Filler with `desktop-release/PDF Filler Setup 1.0.8.exe`, then set it as your PDF default in Windows:
