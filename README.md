...
- Installer: `desktop-release/PDF Filler Setup 1.0.7.exe`
...
Install PDF Filler with `desktop-release/PDF Filler Setup 1.0.7.exe`, then set it as your PDF default in Windows:
